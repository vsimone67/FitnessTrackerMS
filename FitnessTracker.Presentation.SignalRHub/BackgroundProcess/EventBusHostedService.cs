    ...
    public class EventBusHostedService : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            return Task.Factory.StartNew(async () =>
            {
                ...
                _eventBus.Subscribe<WorkoutCompletedEvent, WorkoutCompletedEventHanlder>(_appSettings.Value.ConnectionAtributes.RabbitExchangeInfo[Workout].Queue[Queue], _appSettings.Value.ConnectionAtributes.RabbitExchangeInfo[Workout].ExchangeName);
