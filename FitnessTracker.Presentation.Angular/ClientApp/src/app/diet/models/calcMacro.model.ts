...
export class CalcMacro {
    ...
    calcProtein() {
        return this.calcNumber(this.calcCalories(), this.currentMacros.protein, this.currentMacros.proteinFactor);
    }
    caclCarbs() {
        return this.calcNumber(this.calcCalories(), this.currentMacros.carbs, this.currentMacros.carbsFactor);
    }
    calcFat() {
        return this.calcNumber(this.calcCalories(), this.currentMacros.fat, this.currentMacros.fatFactor);
    }
