...
@NgModule({
  imports: [
    ...
    CommonModule,
    AgGridModule.withComponents([ServingDropDownComponent,
      MealCheckBoxComponent, EditImageComponent, DeleteImageComponent]),
    NgxsModule.forRoot([DietState])    
  ],
  declarations: [CreateDietComponent, EditMetabolicInfoComponent, DeleteImageComponent, EditImageComponent, MealCheckBoxComponent, ServingDropDownComponent, MacroCalculatorComponent, MetabolicCounterComponent],
  exports: [CreateDietComponent, EditMetabolicInfoComponent, DeleteImageComponent, EditImageComponent, MealCheckBoxComponent, ServingDropDownComponent, MacroCalculatorComponent, MetabolicCounterComponent],
