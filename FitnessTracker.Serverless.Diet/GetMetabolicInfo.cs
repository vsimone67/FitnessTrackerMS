    ...
    public static class GetMetabolicInfo
    {
        ...
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = null)] HttpRequest req, ILogger log, ExecutionContext context)
        {
            ...
            try
            {
                ...
                var queryHanlder = new GetMetabolicInfoQueryHandler(ftEnvironment.DietService, ftEnvironment.Mapper);
                var results = queryHanlder.Handle(new GetMetabolicInfoQuery());
